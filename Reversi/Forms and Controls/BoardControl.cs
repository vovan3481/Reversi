    ...
    public partial class BoardControl : UserControl
    {
        ...
        private void ShowGameFinished()
        {
            ...
            if (player1Score != player2Score)
            {
                ...
                message = String.Format("{0} выиграл игру.", winnerName);
            }
            else
            {
        ...
        private void RefreshCurrentMoveInfo()
        {
            ...
            this.lblCurrentPlayer.Text = String.Format("Ход {0}.", nextPlayer.Name);
        }
        ...
        private void RefreshTime()
        {
            ...
            this.lblMoveDuration.Text = String.Format("Продолжительность хода:   {0:00}:{1:00}", timeElapsed.Minutes, timeElapsed.Seconds);
        }
        ...
        private void ctrlPlayer2_Load(object sender, EventArgs e)
        {
