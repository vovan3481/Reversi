...
//событие при попадании курсора в область
        ...
        //отрисовка возможного хода (выделяет квадратиком)
        ...
        protected override void OnMouseLeave(EventArgs e)
        {
            ...
            if (this.mIsMouseOver)
            {
                // Очистка выделенного потенциального хода
                this.Refresh();
                this.mIsMouseOver = false;
            }
        }        

        //при нажатии мышкой на клетку поля
